...
# Send
  - _messages_
    - **ClientHello**
      ...
      - unixTime: DA BA 95 7B
      - random: DA BA 95 7B 60 B4 20...
      - sessionIdLength: 0
      - sessionId
      - compressionLength: 1
...
# ReceiveTill
  - _messages_
    - **ServerHello**
      ...
      - extensionsLength: 5
      - protocolVersion: 03 03
      - unixTime: 20 6D 9D 4E
      - random: 20 6D 9D 4E 0B 1C B7...
      - sessionIdLength: 0
      - sessionId
...
# SendDynamicClientKeyExchange
  - _messages_
    - **RSAClientKeyExchange**
      ...
      - computations
        - clientServerRandom: DA BA 95 7B 60 B4 20...
...
# Send
  - _messages_
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: E2 49 20 55 7E 27 6A...
  - _httpMessages_: None
# ReceiveTill
  - _messages_
    - **ChangeCipherSpec**
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: 03 75 BC BA 15 FC EC...
  - _httpMessages_: None
  - Finished: None
# Send
  - _messages_
