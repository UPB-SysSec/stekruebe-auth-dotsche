...
# Send
  - _messages_
    - **ClientHello**
      ...
      - unixTime: DA BA 85 0C
      - random: DA BA 85 0C 60 B4 20...
      - sessionIdLength: 0
      - sessionId
      - compressionLength: 1
...
# ReceiveTill
  - _messages_
    - **ServerHello**
      ...
      - extensionsLength: 5
      - protocolVersion: 03 03
      - unixTime: B6 ED CA 06
      - random: B6 ED CA 06 E3 09 4C...
      - sessionIdLength: 0
      - sessionId
...
# SendDynamicClientKeyExchange
  - _messages_
    - **RSAClientKeyExchange**
      ...
      - computations
        - clientServerRandom: DA BA 85 0C 60 B4 20...
...
# Send
  - _messages_
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: 57 9F 99 C5 EE 9F E2...
  - _httpMessages_: None
# ReceiveTill
  - _messages_
    - **ChangeCipherSpec**
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: 6E D4 76 26 8E 69 F8...
  - _httpMessages_: None
  - Finished: None
# Send
  - _messages_
