...
# Send
  - _messages_
    - **ClientHello**
      ...
      - unixTime: DB 93 62 23
      - random: DB 93 62 23 60 B4 20...
      - sessionIdLength: 0
      - sessionId
      - compressionLength: 1
...
# ReceiveTill
  - _messages_
    - **ServerHello**
      ...
      - extensionsLength: 5
      - protocolVersion: 03 03
      - unixTime: 2C 81 F6 A1
      - random: 2C 81 F6 A1 30 D1 C2...
      - sessionIdLength: 0
      - sessionId
...
# SendDynamicClientKeyExchange
  - _messages_
    - **RSAClientKeyExchange**
      ...
      - computations
        - clientServerRandom: DB 93 62 23 60 B4 20...
...
# Send
  - _messages_
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: 68 C9 1C 61 FD 11 CA...
  - _httpMessages_: None
# ReceiveTill
  - _messages_
    - **ChangeCipherSpec**
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: E4 7F 5F 8B CC D0 D6...
  - _httpMessages_: None
  - Finished: None
# Send
  - _messages_
