...
# Send
  - _messages_
    - **ClientHello**
      ...
      - unixTime: DA BA 25 BE
      - random: DA BA 25 BE 60 B4 20...
      - sessionIdLength: 0
      - sessionId
      - compressionLength: 1
...
# ReceiveTill
  - _messages_
    - **ServerHello**
      ...
      - extensionsLength: 5
      - protocolVersion: 03 03
      - unixTime: 5D 05 F0 83
      - random: 5D 05 F0 83 5B 20 FD...
      - sessionIdLength: 0
      - sessionId
...
# SendDynamicClientKeyExchange
  - _messages_
    - **RSAClientKeyExchange**
      ...
      - computations
        - clientServerRandom: DA BA 25 BE 60 B4 20...
...
# Send
  - _messages_
    ...
    - **Finished**
      - type: 20
      - length: 12
      - verifyData: 2B 61 2C 91 51 1A D8...
  - _httpMessages_: None
# ReceiveTill
  - _messages_
    - **Alert**
